...
開始から約2秒後、夜空に顔のついた大きな星が現れます。その後は約4秒ごとに1つずつ増え、最大3個まで表示します。タッチすると回転して、ハートやにこにこ顔の特別な花火に変わり、動物がばんざいします。星には時間制限がなく、無視して自由に遊ぶこともできます。触った星の空き枠は約2秒を目安に補充します。星は触るまで消えず、制限時間・取り逃し・ペナルティはありません。
